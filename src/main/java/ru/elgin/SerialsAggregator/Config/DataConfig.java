package ru.elgin.SerialsAggregator.Config;
...
@ComponentScan("ru.elgin.SerialsAggregator")
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("ru.elgin.SerialsAggregator.Repository")
public class DataConfig {
    ...
    private static final String PROP_ENTITYMANAGER_PACKAGES_TO_SCAN = "hibernate.package_to_scan";
